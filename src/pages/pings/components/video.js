    ...
    return new Promise((resolve, reject) => {
      ...
      navigator.getUserMedia(
        ...
        stream => {
          ...
          console.log(navigator.getUserMedia, stream)
...
Video.propTypes = {
  isMediaCalling: PropTypes.bool.isRequired,
  openCalling: PropTypes.func.isRequired,
  closeCalling: PropTypes.func.isRequired,
...
export default connect(mapStateToProps, { openCalling, closeCalling })(Video);
